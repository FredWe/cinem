...
$result = mysql_query("SELECT * FROM `AL_WEI_Films` ");
...
while($row = mysql_fetch_array($result))
  ...
  echo "<td>" . $row['Scenariste'] . "</td>";
  echo "<td>" . $row['Acteurs'] . "</td>";
  echo "<td>" . $row['Cible'] . "</td>";
  echo "<td>" . $row['Resume'] . "</td>";
  echo "<td>" . $row['Salle'] . "</td>";
  echo "<td>" ;
if ($row['AccesHandicapes']) echo "Oui </td>";
else echo "Non </td>";
